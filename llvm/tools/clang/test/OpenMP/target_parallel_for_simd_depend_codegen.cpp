...
// CHECK-64: [[TASK_PRIVS_T]] = type { [3 x i8*], [3 x i8*], [3 x i[[SZ:64|32]]], i32, i8 }
// CHECK-32: [[TASK_PRIVS_T]] = type { i32, [3 x i8*], [3 x i8*], [3 x i[[SZ:64|32]]], i8 }
// CHECK: [[TASK_T_PRIV2:%.+]] = type { [[TASK_T]], [[TASK_PRIVS_T2:%.+]] }
// CHECK-64: [[TASK_PRIVS_T2]] = type { [3 x i8*], [3 x i8*], [3 x i[[SZ]]], i32, i8 }
// CHECK-32: [[TASK_PRIVS_T2]] = type { i32, [3 x i8*], [3 x i8*], [3 x i[[SZ:64|32]]], i8 }
// CHECK: [[TASK_T_PRIV3:%.+]] = type { [[TASK_T]], [[TASK_PRIVS_T3:%.+]] }
// CHECK-64: [[TASK_PRIVS_T3]] = type { [3 x i8*], [3 x i8*], [3 x i[[SZ]]], i32, i8 }
// CHECK-32: [[TASK_PRIVS_T3]] = type { i32, [3 x i8*], [3 x i8*], [3 x i[[SZ:64|32]]], i8 }
// CHECK: [[TASK_T_PRIV4:%.+]] = type { [[TASK_T]], [[TASK_PRIVS_T4:%.+]] }
// CHECK-64: [[TASK_PRIVS_T4]] = type { [3 x i8*], [3 x i8*], [3 x i[[SZ]]], i32, i8 }
// CHECK-32: [[TASK_PRIVS_T4]] = type { i32, [3 x i8*], [3 x i8*], [3 x i[[SZ:64|32]]], i8 }

// CHECK: [[SIZES:@.+]] = private unnamed_addr constant [3 x i[[SZ]]] [i[[SZ]] 4, i[[SZ]] 1, i[[SZ]] 4]
// CHECK: [[MAPTYPES:@.+]] = private unnamed_addr constant [3 x i64] [i64 35, i64 800, i64 800]
// CHECK: [[MAPTYPES_:@.+]] = private unnamed_addr constant [3 x i64] [i64 35, i64 800, i64 800]
// CHECK: [[SIZES2:@.+]] = private unnamed_addr constant [3 x i[[SZ]]] [i[[SZ]] 4, i[[SZ]] 1, i[[SZ]] 4]
// CHECK: [[MAPTYPES2:@.+]] = private unnamed_addr constant [3 x i64] [i64 35, i64 800, i64 800]
// CHECK: [[MAPTYPES2_:@.+]] = private unnamed_addr constant [3 x i64] [i64 35, i64 800, i64 800]

// CHECK: define {{.*}}[[MAIN:@.+]](
int main(int argc, char** argv) {
  int a, b;
  #pragma omp target parallel for depend(inout:a) map(tofrom:b) if(a) device(a+b) private(argc) firstprivate(a)
  for (int i = 0; i < 10; i++) {
    b++;
  }
  #pragma omp target parallel for depend(inout:a) map(tofrom:b) if(a) device(a+b) private(argc) firstprivate(a) nowait
  for (int i = 0; i < 10; i++) {
    b++;
  }
}
...
// CHECK: [[BASEPTRS:%.+]] = alloca [3 x i8*],
// CHECK: [[PTRS:%.+]] = alloca [3 x i8*],
// CHECK: [[AGG_CAPT:%.+]] = alloca [[ANON_T]],
// CHECK: [[BASEPTRS2:%.+]] = alloca [3 x i8*],
// CHECK: [[PTRS2:%.+]] = alloca [3 x i8*],
// CHECK: [[AGG_CAPT2:%.+]] = alloca [[ANON_T2]],
// CHECK: [[BASEPTRS_GEP0:%.+]] = getelementptr {{.+}} [3 x i8*], [3 x i8*]* [[BASEPTRS]], {{.+}} 0, {{.+}} 0
// CHECK: [[BASEPTRS_GEP0_CAST:%.+]] = bitcast i8** [[BASEPTRS_GEP0]] to i32**
// CHECK: store {{.+}}* [[B_LOC]], {{.+}}** [[BASEPTRS_GEP0_CAST]],
// CHECK: [[PTRS_GEP0:%.+]] = getelementptr {{.+}} [3 x i8*], [3 x i8*]* [[PTRS]], {{.+}} 0, {{.+}} 0
// CHECK: [[PTRS_GEP0_CAST:%.+]] = bitcast i8** [[PTRS_GEP0]] to i32**
// CHECK: store {{.+}}* [[B_LOC]], {{.+}}** [[PTRS_GEP0_CAST]],
// CHECK: [[BASEPTRS_TOCPY:%.+]] = getelementptr {{.+}} [3 x i8*], [3 x i8*]* [[BASEPTRS]], {{.+}} 0, {{.+}} 0
// CHECK: [[PTRS_TOCPY:%.+]] = getelementptr {{.+}} [3 x i8*], [3 x i8*]* [[PTRS]], {{.+}} 0, {{.+}} 0
...
// CHECK-32: [[TASK_PRIV_GEP0:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[TASK_PRIV_VAR]], {{.+}} 0, {{.+}} 1
// CHECK: [[TASK_PRIV_GEP0_CAST:%.+]] = bitcast [3 x i8*]* [[TASK_PRIV_GEP0]] to i8*
...
// CHECK-32: [[TASK_PRIV_GEP1:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[TASK_PRIV_VAR]], {{.+}} 0, {{.+}} 2
// CHECK: [[TASK_PRIV_GEP1_CAST:%.+]] = bitcast [3 x i8*]* [[TASK_PRIV_GEP1]] to i8*
...
// CHECK-32: [[TASK_PRIV_GEP2:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[TASK_PRIV_VAR]], {{.+}} 0, {{.+}} 3
// CHECK: [[TASK_PRIV_GEP2_CAST:%.+]] = bitcast [3 x i[[SZ]]]* [[TASK_PRIV_GEP2]] to i8*
// CHECK: call void @llvm.memcpy.{{.+}}(i8* [[TASK_PRIV_GEP2_CAST]], i8* bitcast ([3 x i[[SZ]]]* [[SIZES]] to i8*), {{.+}})

// CHECK: {{.+}} = call {{.+}} @__kmpc_omp_task_with_deps(%ident_t* @{{.+}}, i32 [[GTID:%[^,]+]], {{.+}})
// CHECK: call i32 @__kmpc_omp_taskwait(%ident_t* @{{.+}}, i32 [[GTID]])
// CHECK: ret {{.+}}
// CHECK: }

// CHECK: define {{.+}} void [[MAP_FUN:@.+]]([[TASK_PRIVS_T]]* {{.+}}, [3 x {{.+}}*]** {{.+}}, [3 x {{.+}}*]** {{.+}}, [3 x i[[SZ]]]** {{.+}}) {{.+}}
// CHECK: [[ADDR:%.+]] = alloca [[TASK_PRIVS_T]]*,
// CHECK: [[BASES_L:%.+]] = alloca [3 x {{.+}}*]**,
// CHECK: [[PTRS_L:%.+]] = alloca [3 x {{.+}}*]**,
// CHECK: [[SIZES_L:%.+]] = alloca [3 x i[[SZ]]]**,
// CHECK: store [[TASK_PRIVS_T]]* {{.+}}, [[TASK_PRIVS_T]]** [[ADDR]],
// CHECK: store [3 x {{.+}}*]** {{.+}}, [3 x {{.+}}*]*** [[BASES_L]],
// CHECK: store [3 x {{.+}}*]** {{.+}}, [3 x {{.+}}*]*** [[PTRS_L]],
// CHECK: store [3 x i[[SZ]]]** {{.+}}, [3 x i[[SZ]]]*** [[SIZES_L]],
// CHECK: [[ADDR_V:%.+]] = load [[TASK_PRIVS_T]]*, [[TASK_PRIVS_T]]** [[ADDR]],
// CHECK-64: [[ADDR_V_GEP0:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 0
// CHECK-32: [[ADDR_V_GEP0:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 1
// CHECK: [[BASES_L_LD:%.+]] = load [3 x {{.+}}*]**, [3 x {{.+}}*]*** [[BASES_L]],
// CHECK: store [3 x {{.+}}*]* [[ADDR_V_GEP0]], [3 x {{.+}}*]** [[BASES_L_LD]],

// CHECK-64: [[ADDR_V_GEP1:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 1
// CHECK-32: [[ADDR_V_GEP1:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 2
// CHECK: [[PTRS_L_LD:%.+]] = load [3 x {{.+}}*]**, [3 x {{.+}}*]*** [[PTRS_L]],
// CHECK: store [3 x {{.+}}*]* [[ADDR_V_GEP1]], [3 x {{.+}}*]** [[PTRS_L_LD]],

// CHECK-64: [[ADDR_V_GEP2:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 2
// CHECK-32: [[ADDR_V_GEP2:%.+]] = getelementptr {{.+}} [[TASK_PRIVS_T]], [[TASK_PRIVS_T]]* [[ADDR_V]], {{.+}} 0, {{.+}} 3
// CHECK: [[SIZES_L_LD:%.+]] = load [3 x i[[SZ]]]**, [3 x i[[SZ]]]*** [[SIZES_L]],
// CHECK: store [3 x i[[SZ]]]* [[ADDR_V_GEP2]], [3 x i[[SZ]]]** [[SIZES_L_LD]],
// CHECK: ret void
...
// CHECK: call void ({{.+}}) [[COPY_FN_REF]](i8* [[PRIVS_REF]], {{[^[]+}}[3 x {{.+}}*]** [[BASES_L]], [3 x {{.+}}*]** [[PTRS_L]], [3 x i[[SZ]]]** [[SIZES_L]])

// actual target invocation
// CHECK: [[BASES_PTR:%.+]] = load [3 x {{.+}}*]*, [3 x {{.+}}*]** [[BASES_L]],
// CHECK: [[PTRS:%.+]] = load [3 x {{.+}}*]*, [3 x {{.+}}*]** [[PTRS_L]],
// CHECK: [[SIZES_PTR:%.+]] = load [3 x i[[SZ]]]*, [3 x i[[SZ]]]** [[SIZES_L]],
// CHECK: [[BASES_GEP:%.+]] = getelementptr {{.+}} [3 x {{.+}}*], [3 x {{.+}}*]* [[BASES_PTR]], {{.+}} 0, {{.+}} 0
// CHECK: [[PTRS_GEP:%.+]] = getelementptr {{.+}} [3 x {{.+}}*], [3 x {{.+}}*]* [[PTRS]], {{.+}} 0, {{.+}} 0
// CHECK: [[SIZES_GEP:%.+]] = getelementptr {{.+}} [3 x i[[SZ]]], [3 x i[[SZ]]]* [[SIZES_PTR]], {{.+}} 0, {{.+}} 0
