...
void depend_nowait(int arg, float arg2) {
  ...
  // CK5-NEXT:  call void @__tgt_target_data_update_nowait_depend(i64 -1, i32 1, i8** %{{.+}}, i8** %{{.+}}, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i32 2, i8* %{{.+}}, i32 0, i8* null)
  #pragma omp target update from(arg) depend(out: arg) depend(in : arg2) nowait
  {++arg;}
}
#endif
#ifdef CK6
