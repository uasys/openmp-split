...
void depend_no_nowait(int arg, float arg2) {
  ...
  // CK6-NEXT:  call void @__tgt_target_data_end_depend(i64 -1, i32 1, i8** %{{.+}}, i8** %{{.+}}, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i32 2, i8* %{{.+}}, i32 0, i8* null)
  #pragma omp target exit data map(from: arg) depend(out: arg) depend(in : arg2)
  {++arg;}
}
#endif
#endif
