...
// CK1: [[SIZE04:@.+]] = {{.+}}constant [2 x i[[sz]]] [i[[sz]] sub nuw (i[[sz]] add nuw (i[[sz]] ptrtoint (double** getelementptr inbounds (%struct.ST, %struct.ST* @gb, i32 0, i32 1) to i[[sz]]), i[[sz]] {{8|4}}), i[[sz]] ptrtoint (double** getelementptr inbounds (%struct.ST, %struct.ST* @gb, i32 0, i32 1) to i[[sz]])), i[[sz]] 24]
...
void depend_nowait(int arg, float arg2) {
  ...
  // CK5-NEXT:  call void @__tgt_target_data_begin_nowait_depend(i64 -1, i32 1, i8** %{{.+}}, i8** %{{.+}}, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i32 2, i8* %{{.+}}, i32 0, i8* null)
  #pragma omp target enter data map(to: arg) depend(out: arg) depend(in : arg2) nowait
  {++arg;}
}
#endif
#ifdef CK6
...
void depend_no_nowait(int arg, float arg2) {
  ...
  // CK6-NEXT:  call void @__tgt_target_data_begin_depend(i64 -1, i32 1, i8** %{{.+}}, i8** %{{.+}}, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i64* getelementptr inbounds ([1 x i64], [1 x i64]* @{{.+}}, i32 0, i32 0), i32 2, i8* %{{.+}}, i32 0, i8* null)
  #pragma omp target enter data map(to: arg) depend(out: arg) depend(in : arg2)
  {++arg;}
}
#endif
#endif
